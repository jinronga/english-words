...
四级、六级、专四、专八词表已补充英式/美式音标，其余列与教材词表保持一致。
...
`scripts/generate_tem_vocab.py` 用于从 english.mikigo.site 重新生成专四、专八 Markdown 文件：

```bash
python3 scripts/generate_tem_vocab.py
```
...
- `index.md`：学习入口首页，先按小学、初中、高中、四级、六级、专四、专八进入分类页
